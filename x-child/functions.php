...
function my_addition_script() {
    ...
    <script>
        /**
         * Created by ace on 9/20/2016.
         */
        window.onload = function(){
            if(document.getElementsByClassName("custom_learn_more")){
                document.getElementsByClassName("custom_learn_more")[0].onclick = function(){
                   // window.open("http://angelserotics.titusshoats.com/events/booking/");
                }
            }else{
                alert("False");
            }
